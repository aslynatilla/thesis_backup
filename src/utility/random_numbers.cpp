...
std::vector<float> random_num::uniform_samples_in_unit_interval(const unsigned int number_of_samples) {
...
std::vector<glm::vec3> random_num::random_polar_offsets(const unsigned int number_of_offsets) {
